...
const QRScannerOverlay: React.FC<QRScannerOverlayProps> = ({
    ...
    return (
        <div className="absolute inset-0">
            {/* 상단 텍스트 영역 */}
            <div className="absolute top-0 left-0 right-0 text-center pt-6 pb-8 z-20 bg-gradient-to-b from-black/70 to-transparent">
                <h2 className="text-xl font-bold text-white mb-2">QR 인식</h2>
                <p className="text-white text-sm pt-4">{getStatusText()}</p>
            </div>

            {/* 마스크 오버레이 */}
            <div className="absolute inset-0 z-10 flex items-center justify-center px-6">
                <div
                    className="max-w-[300px] w-full aspect-square rounded-lg"
                    style={{
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20 px-6">
                <div className="relative max-w-[303px] w-full aspect-square">
